...
- **自動整理**：搜尋頁「我的最愛」旁一顆開關，開著之後 OpenAver 每 12 小時自動幫最愛資料夾跑一次「搜尋 → 整理」，人不必在場；也能隨時按「立刻執行一次」馬上跑一輪，結果看側欄通知。你按「我的最愛」的當下，背景那一輪會做完手上那一部就停下來讓位；其餘操作不會打斷它，但十分鐘內有你的動作時，下一次排程會自動跳過。
